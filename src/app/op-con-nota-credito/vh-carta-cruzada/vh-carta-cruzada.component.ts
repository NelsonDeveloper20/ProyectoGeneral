...
@Component({
  selector: 'app-vh-carta-cruzada',
  templateUrl: './vh-carta-cruzada.component.html',
  styleUrls: ['./vh-carta-cruzada.component.css'],
})
export class VhCartaCruzadaComponent implements OnInit {
  datePipe: DatePipe;
  /*
"Aprobaciones"
...
"Rechazado Contabilidad"
  */
  ...
  ProcederRegistro() {
    ...
    formData.append('tiposolicitud', '4'); //carta cruzada
...
*/
  ...
  EnviarBD(paso, estado, subestado, motivo,motivorechazodevolucion?:string) {
    ...
    var parametros =
      ...
      subestado +
      '&motivo=' +
      motivo+'&motivorechazodevolucion='+motivorechazodevolucion;
    this.http
      .put<IApiResponse>(
        this.urlBase +
  ...
  EnvioTesoreria() {
    ...
    formData.append('archivo', this.archivoNotaCredito);
