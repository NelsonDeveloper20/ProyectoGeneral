...
@Component({
  selector: 'app-vh-anulacion-nuevocomprobante',
  templateUrl: './vh-anulacion-nuevocomprobante.component.html',
  styleUrls: ['./vh-anulacion-nuevocomprobante.component.css']
})
export class VhAnulacionNuevocomprobanteComponent implements OnInit {
  ...
  constructor(private _location: Location,
    ...
    if (this.router.getCurrentNavigation()?.extras.state) {
      ...
      this.fechaAplicacion= new Date(this.itemsolicitud.fechSolicitud);
  ...
  ProcederRegistro() {
    ...
    this.user.comentario = this.user.comentario
    debugger;

    this._SGeneralService.RegistrarSolicitudBDGeneral(this.unidadSeleccionada, this.user, this.EstadoSolicitud, this.filasData, "1",
