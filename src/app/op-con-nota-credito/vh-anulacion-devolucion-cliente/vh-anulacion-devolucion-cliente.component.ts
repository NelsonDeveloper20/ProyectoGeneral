...
@Component({
  selector: 'app-vh-anulacion-devolucion-cliente',
  templateUrl: './vh-anulacion-devolucion-cliente.component.html',
  styleUrls: ['./vh-anulacion-devolucion-cliente.component.css']
})
export class VhAnulacionDevolucionClienteComponent implements OnInit {
...
"Rechazado Contabilidad"
  */
  ...
  ProcederRegistro() {
    ...
    this.spinner.show();
    this._SGeneralService.RegistrarSolicitudBDGeneral(this.unidadSeleccionada, this.user, this.EstadoSolicitud, this.filasData, "2"
  ...
  RegistrarSolicitudBD() {
    ...
    if (this.user.id == undefined) {
      ...
      if (countunidad == 0) {
        this.toaster.open({
          text: "No tienes asignado ninguna U.N para tu rol, comuniquese con su administrador",
          caption: 'Mensaje',
          type: 'warning',
          position: 'bottom-right',
          //duration: 4000
