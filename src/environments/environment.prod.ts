...
export const environment = {
  ...
  authRedirectUri: 'https://aprobaciones.grupopana.com.pe', 
  logoutRedirectUri: 'https://aprobaciones.grupopana.com.pe/#/', 
  baseUrl: 'https://aprobaciones.grupopana.com.pe/services', //
